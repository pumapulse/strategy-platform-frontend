...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0e1a]">
          ...
          <RevealSection variant="right" className="lg:col-span-3">
            {sent ? (
              <div className="flex flex-col items-center justify-center text-center p-16 rounded-2xl border border-emerald-500/20 bg-emerald-500/[0.04] min-h-[480px]">
                ...
                <p className="text-white/40 text-sm max-w-xs mb-8 leading-relaxed">We will get back to you within 1-2 business days. Keep an eye on your inbox.</p>
      ...
      {/* Bottom strip */}
      <section className="border-t border-white/[0.06] bg-[#060a14] py-12">
