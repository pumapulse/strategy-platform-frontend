    ...
    <div className="min-h-screen bg-[#0a0e1a]">
      ...
      <section className="relative overflow-hidden min-h-[60vh] flex items-end border-b border-white/[0.06]">
        <div className="absolute inset-0">
          <img src="/img/security/Annotation 2026-04-04 220851.jpg" alt="Security" className="w-full h-full object-cover opacity-[0.15]" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
